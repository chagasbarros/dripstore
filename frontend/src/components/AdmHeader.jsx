      ...
      <nav className="navbar navbar-expand-lg navbar-light px-4 py-3">
        <div className="container-fluid">
          <Link className="navbar-brand d-flex align-items-center" to="/dripStore/Home">
            ...
            />
            <span className="text-pink fw-bold" style={{ color: "#d10f7d", fontSize: "1.5rem" }}>
              Digital Store
            </span>
          </Link>
          ...
          <div className={`collapse navbar-collapse ${isMenuOpen ? "show" : ""}`} id="navbarNav">
            ...
            >
              ...
              />
              <button className={`btn btn-outline ${styles.pesquisa}`} type="submit">
            ...
            <ul className="navbar-nav me-auto mt-3 mt-lg-0 d-xl-flex d-lg-none">
              ...
              <li className="nav-item">
                <NavLink to="/DripStore/Vendas" className={getNavLinkClass} style={{ fontSize: "14px", whiteSpace: "nowrap", color: "black" }}>
                  Vendas
                </NavLink>
              </li>
            </ul>
