...
import styles from "./Carrinho.module.css"; // Componente principal da página do carrinho
            ...
            <div className="row">
              ...
              <div className="col-md-6 mb-3">
                ...
                <div className="input-group">
                  ...
                  <input
                    type="text"
                    className={` ${styles.BotaoOk} form-control rounded-3`}
                    placeholder="Insira seu código"
                    id={styles.BotaoOk}
                  />
                  {/* Botão para aplicar cupom */}
                  <button
                    className={` ${styles.BotaoOk} btn btn-outline-pink ms-3 rounded-3`}
                  >
                    OK
                  </button>
                </div>
